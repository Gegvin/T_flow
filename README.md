...
В файле valid.tflow содержатся верные примеры различных языковых конструкций. Остальные файлы содержат примеры ошибок.
...
## Вклад в проект
Индусов Никита: VS Code extension skeleton, language registration, syntax highlighting, language configuration.
Суслов Павел: diagnostics, подключение lexer/parser,  syntax checks.
Лагойда Андрей: completion, examples, tests.
