...
7. Исправления добавляются в ту же ветку в тот же самый MR (новый MR создавать не нужно). После отправки всех исправлений нужно запросить повторную проверку через интерфейс gitlab.
